            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div class="bg-yellow-50 p-6 rounded-lg shadow-md">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <h4 class="font-bold text-yellow-700">Yashika</h4>
        ...
        <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div class="flex space-x-4 justify-center">
              <a href="https://x.com/home?lang=en" class="hover:text-yellow-300 transition">
                <i class="fab fa-twitter"></i>
              </a>
              <a href="https://www.facebook.com/login/" class="hover:text-yellow-300 transition">
                <i class="fab fa-facebook"></i>
              </a>
              <a href="https://www.instagram.com/?hl=en" class="hover:text-yellow-300 transition">
                <i class="fab fa-instagram"></i>
              </a>
              <a href="https://www.linkedin.com/feed/" class="hover:text-yellow-300 transition">
